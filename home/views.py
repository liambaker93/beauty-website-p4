...
def calendar_feed(request):
    """
    This creates bookings to be displayed on to the calendars
    throughout the site, only displaying a user's orders
    to that user. But displays all to staff users.
    """
